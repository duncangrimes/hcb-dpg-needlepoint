  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-900 pb-24">
      ...
      <button
        onClick={handleCreateNew}
        disabled={creating}
        className="sm:hidden fixed bottom-20 right-4 w-14 h-14 bg-terracotta-600 hover:bg-terracotta-700 text-white rounded-full shadow-lg flex items-center justify-center transition active:scale-95 disabled:opacity-50 z-20"
