...
export function PreviewStep() {
  ...
  // Auto-generate on mount (only for authenticated users)
  useEffect(() => {
    if (!hasAutoGenerated.current && placedCutouts.length > 0 && !isProcessing && !result && session && !isAuthLoading) {
      hasAutoGenerated.current = true;
      handleGenerate();
    }
  }, [placedCutouts.length, isProcessing, result, handleGenerate, session, isAuthLoading]);
