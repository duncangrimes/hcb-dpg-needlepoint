  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 animate-slide-up">
        <div className="bg-white dark:bg-stone-900 rounded-t-2xl shadow-xl max-h-[70vh] overflow-y-auto safe-area-inset-bottom">
          {/* Handle */}
          ...
          {/* Header */}
          <div className="flex items-center justify-between px-5 pb-4 border-b border-stone-200 dark:border-stone-700">
          ...
          <div className="p-5 space-y-6">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs text-stone-500 mb-1 block">Width (inches)</label>
                  <input
                    type="number"
                    min={4}
                    max={24}
                    ...
                    className="w-full px-3 py-2 bg-stone-100 dark:bg-stone-800 rounded-lg text-center font-medium"
                  />
                </div>
                <div>
                  <label className="text-xs text-stone-500 mb-1 block">Height (inches)</label>
                  <input
                    type="number"
                    min={4}
                    max={24}
