  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 animate-slide-up">
        <div className="bg-white dark:bg-gray-900 rounded-t-2xl shadow-xl max-h-[60vh] overflow-hidden safe-area-inset-bottom">
          {/* Handle */}
              ...
              reversedCutouts.map((placed, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Thumbnail */}
                    <div className="w-12 h-12 rounded-lg overflow-hidden bg-white border border-gray-200 dark:border-gray-700 flex-shrink-0">
                      {thumbnail && (
                        <img
                          src={thumbnail}
                          alt=""
          ...
          {reversedCutouts.length > 1 && (
            <div className="px-4 py-3 border-t border-gray-200 dark:border-gray-700 text-center text-sm text-gray-500">
